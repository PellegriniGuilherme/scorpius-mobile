  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ padding: tokens.space[6], gap: tokens.space[4] }}>
        ...
        <Card>
          <Text style={{ color: colors.textMuted, fontSize: tokens.text.xs, marginBottom: tokens.space[2] }}>DESCRIÇÃO</Text>
          <TextInput
            value={notes}
        ...
        <Button label="Enviar" onPress={() => void handleSubmit()} loading={submitting} disabled={!selectedSlug} fullWidth />
      </ScrollView>
    </ScrollView>
  );
}
