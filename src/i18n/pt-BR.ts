...
export const ptBR = {
  ...
  map: {
    ...
    placeholder: 'Configure EXPO_PUBLIC_GOOGLE_MAPS_API_KEY para ver o mapa nativo. Você ainda pode abrir a navegação no Google Maps.',
    noKeyTitle: 'Mapa indisponível',
    tollsTitle: 'Pedágios',
    tollsEmpty: 'Nenhuma praça identificada nesta rota.',
    stationsTitle: 'Postos próximos',
    stationsEmpty: 'Nenhum posto encontrado ao longo da rota.',
    gasolina: 'Gasolina',
    etanol: 'Etanol',
    diesel: 'Diesel',
    ageDays: '{days}d',
    openStation: 'Navegar até o posto',
  },
  proof: {
